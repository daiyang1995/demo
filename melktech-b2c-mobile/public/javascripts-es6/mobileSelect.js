...
(function() {
	...
	MobileSelect.prototype = {
		...
		resetValue:function (resetValue) {
			var _this = this;
			var data = _this.wheelsData[0].data;
			var positionArr = [];
			var idStr = _this.keyMap.id;
			var childsStr = _this.keyMap.childs ?_this.keyMap.childs :"childs";
			if(_this.cascade){
				for(var i = 0; i<_this.wheel.length; i++){
			...
			_this.reSetCurDistance(positionArr);
			_this.ensureBtn.click();
		},
		getValue: function(){
			var _this = this;
			var temp = [];
		...
		reSetCurDistance: function(indexArr){
			var _this = this;
			var temp = [];
			for(var i=0; i<_this.slider.length; i++){
				temp.push(_this.calcDistance(indexArr[i]));
